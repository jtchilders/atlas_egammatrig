...
### Input files
#DIR = '/dataDisk/Collisions/periodI_Zee/*/*'
DIR = '/dataDisk/Collisions/00167776/data10_7TeV.00167776.physics_Egamma.merge.AOD.f299_m639/*'
...
from TrigEgammaAnalysis.TrigEgammaAnalysisConf import TrigEgammaTRTAnalysis
L1eg = TrigEgammaTRTAnalysis( 'TrigEgammaTRTAnalysis' )
