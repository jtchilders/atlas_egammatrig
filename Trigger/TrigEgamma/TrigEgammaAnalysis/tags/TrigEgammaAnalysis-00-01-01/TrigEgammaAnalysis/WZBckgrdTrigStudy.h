...
private:
   ...
   bool IsIsolated(Jet::hlv_t& emjesJet,const ElectronContainer* electrons,
                   const unsigned int dr = 0.5);
   ...
   unsigned int m_eventsPassing_e20l_2j10;
   unsigned int m_eventsPassing_e20l_3j10;
   unsigned int m_eventsPassing_e20l_4j10;
   unsigned int m_eventsPassing_met;
